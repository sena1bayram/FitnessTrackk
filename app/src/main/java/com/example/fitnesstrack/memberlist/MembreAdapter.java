...
public class MembreAdapter extends FirestoreRecyclerAdapter<Members, MembreAdapter.MembreHolder> {

    MembreAdapter(@NonNull FirestoreRecyclerOptions<Members> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull MembreHolder holder, int position, @NonNull Members model) {
